      ...
      <section className="relative bg-black text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-20 mt-20 z-10">
          ...
          <motion.p
            ...
            className="text-xl md:text-lg max-w-3xl mb-10"
          >
            ...
            {[
              ...
              >
                <img
                  src={img}
                  alt="Luxury item"
                    className="w-full h-40 object-contain transform hover:scale-105 transition duration-700 filter invert brightness-0"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <motion.video
              ...
              src="https://videos.pexels.com/video-files/6867665/6867665-uhd_2560_1440_25fps.mp4"
              autoPlay
              loop
              muted
            ></motion.video>
